...
An animation is, as is explained on this page regarding the <</reference/math/animations/explanations#,mathematics behind animations>>,
...
Using the <</reference/math/animations/explanations#,mathematical formulae>>, we get
