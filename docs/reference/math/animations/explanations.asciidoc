...
The animation is actually a _function_ mapping time values to ``double`` values.
...
Animations can be made smoother using _easing functions_. Below are a few examples:
