...
You may have to look up how to call the base class's version of a method in {cpp}.
====
...
[TASK]
====
Translate the <</reference/lighting/diffuse/explanations#,mathematical formula for diffuse lighting>> into a protected method `compute_diffuse`.
