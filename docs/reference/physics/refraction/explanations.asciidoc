...
When a light ray reaches a transparent material, part of it penetrates the material, at which point the light ray is bent in another direction.
The following explanation is not very exact, but it helps to understand refraction intuitively.

A light ray travels through a medium, for example air, water, glass, diamond, &hellip;
Air is quite thin and photons can move through it mostly unhindered, meaning that a light beam travels through air at almost the speed of light.
Diamonds, however, are very dense, making photons bump into carbon atoms all the time.
As a consequence, a light beam is slowed down considerably, i.e. 2.42&times; slower than the "regular" speed of light.
...
index stem:[n_1] to a medium with refractive index stem:[n_2], we use https://en.wikipedia.org/wiki/Snell%27s_law[Snell's law].
