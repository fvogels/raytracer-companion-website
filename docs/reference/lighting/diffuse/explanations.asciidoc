...
The <</reference/math/dot-product#explanations,dot product>> comes to the rescue. Examine the following cases: the incoming light ray is represented by a yellow vector $\vec i$,
