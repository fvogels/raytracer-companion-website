...
`RayTracerV2` will be structured as follows:
...
[NOTE]
====
Admittedly, this may come across as a lot of unnecessary indirections, but we're simply giving each method one responsibility.
