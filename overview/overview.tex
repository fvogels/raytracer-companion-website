...
\begin{tikzpicture}[extension/.style={draw,minimum width=5cm,minimum height=1cm,font=\scshape,rounded corners=4pt,drop shadow},
  ...
  \begin{pgfonlayer}{main}
    ...
    \node[extension,hard,todo] (voronoi 3d) at ($ (dalmatian 3d material) + (10,0) $) {\html{extensions/math/voronoi3d}{Voronoi 3D} \mathy};
    ...
    \node[extension,easy] (plane yz) at ($ (plane xz) + (0,-2) $) {\html{extensions/primitives/plane-xz}{Plane YZ}};
    ...
    \node[extension,easy,todo] (cone) at ($ (plane yz) + (0,-2) $) {\html{extensions/primitives/plane-xz}{Cone}};
    \draw[dependency] (cone) -| (primitives);

    \node[extension,easy,todo] (optimized cone) at ($ (cone) + (6,0) $) {\html{extensions/primitives/cone-optimized }{Optimized Cone}};
    \draw[dependency] (optimized cone) -| (cone);

    \node[extension,easy,todo] (square) at ($ (cone) + (0,-2) $) {\html{extensions/primitives/cube}{Square}};
    \draw[dependency] (square) -| (primitives);

    \node[extension,easy,todo] (optimized square) at ($ (square) + (6,0) $) {\html{extensions/primitives/square-optimized}{Optimized Square}};
    \draw[dependency] (optimized square) -| (square);

    \node[extension,easy,todo] (cube) at ($ (square) + (0,-2) $) {\html{extensions/primitives/cube}{Cube}};
    ...
    \node[extension,easy,todo] (intersection) at ($ (bumpifier) + (0,-2) $) {\html{extensions/primitives/bumpifier}{Intersection}};
    ...
    \node[extension,easy,todo] (difference) at ($ (intersection) + (0,-2) $) {\html{extensions/primitives/bumpifier}{Difference}};
    ...
    \node[extension,hard,todo] (scaling) at ($ (mesh) + (0,-2) $) {\html{extensions/primitives/scaling}{Scaling}};
    \draw[dependency] (scaling) -| (primitives);

    \node[extension,hard,todo] (rotation) at ($ (scaling) + (0,-2) $) {\html{extensions/primitives/rotation}{Rotation}};
    ...
    \node[extension,easy,todo] (parallel task scheduler) at ($ (performance) + (6,0) $) {\html{extensions/performance/parallel-task-scheduler}{Parallel Scheduler}};
    ...
    \node[extension,easy,todo] (quaternions) at ($ (animations) + (6,-4) $) {\html{extensions/math/quaternions}{Quaternions} \mathy};
