...
\begin{tikzpicture}[extension/.style={draw,minimum width=5cm,minimum height=1cm,font=\scshape,rounded corners=4pt,drop shadow},
  ...
  \begin{pgfonlayer}{main}
    ...
    \node[extension,difficulty=5] (voronoi 2d 2) at ($ (materials) + (6,-8) $) {\html{extensions/math/voronoi2d}{Voronoi 2D} \mathy};
    ...
    \node[extension,difficulty=5] (voronoi 3d 1) at ($ (pattern 2d materials) + (6,2) $) {\html{extensions/math/voronoi3d}{Voronoi 3D} \mathy};
    \draw[dependency] (voronoi 3d 1) -| (pattern 2d materials);

    \node[extension,hard,todo] (dalmatian 3d material) at ($ (voronoi 3d 1) + (6,0) $) {\html{extensions/materials/pattern2d/dalmatian3d}{Dalmatian 3D}};
    \draw[dependency] (dalmatian 3d material) -| (voronoi 3d 1);

    \node[extension,difficulty=5] (voronoi 3d 2) at ($ (materials) + (6,-10) $) {\html{extensions/math/voronoi3d}{Voronoi 3D} \mathy};
    ...
    \node[extension,easy,todo] (elastic animation) at ($ (bounce animation) + (0,-2) $) {\html{extensions/animations/elastic}{Elastic}};
