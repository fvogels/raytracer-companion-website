...
\begin{tikzpicture}[extension/.style={draw,minimum width=5cm,minimum height=1cm,font=\scshape,rounded corners=4pt,drop shadow},
  ...
  \begin{pgfonlayer}{main}
    ...
    \node[extension,difficulty=2] (quaternions) at ($ (animations) + (6,-4) $) {\html{extensions/math/quaternions}{Quaternions} \mathy};
    ...
    \node[extension,difficulty=4] (quadratic animation) at ($ (animations) + (6,-10) $) {\html{extensions/animations/quadratic}{Quadratic}};
    \draw[dependency] (quadratic animation) -| (animations);

    \node[extension,difficulty=4] (cubic animation) at ($ (quadratic animation) + (0,-2) $) {\html{extensions/animations/cubic}{Cubic}};
    \draw[dependency] (cubic animation) -| (animations);

    \node[extension,difficulty=4] (quintic animation) at ($ (cubic animation) + (0,-2) $) {\html{extensions/animations/quintic}{Quintic}};
    \draw[dependency] (quintic animation) -| (animations);

    \node[extension,easy,todo] (point animation) at ($ (quintic animation) + (0,-2) $) {\html{extensions/animations/point}{Points}};
    \draw[dependency] (point animation) -| (animations);

    \node[extension,easy,todo] (angle animation) at ($ (point animation) + (0,-2) $) {\html{extensions/animations/angle}{Angles}};
    \draw[dependency] (angle animation) -| (animations);
    
    \node[extension,easy,todo] (material slicer) at ($ (angle animation) + (0,-2) $) {\html{extensions/materials/slicer}{Slicer}};
