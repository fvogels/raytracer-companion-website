...
\begin{tikzpicture}[extension/.style={draw,minimum width=5cm,minimum height=1cm,font=\scshape,rounded corners=4pt,drop shadow},
                    ...
                    todo/.style={red,top color=gray,bottom color=black,ultra thick}]
  ...
  \begin{pgfonlayer}{main}
    ...
    \node[node] (pattern 2d materials) at ($ (materials) + (6,0) $) {\html{extensions/materials/patterns2d}{Patterns 2D}};
    ...
    \node[extension,easy,todo] (material transformer) at ($ (texture materials) + (0,-2) $) {\html{extensions/materials/transformer}{Transformer}};
