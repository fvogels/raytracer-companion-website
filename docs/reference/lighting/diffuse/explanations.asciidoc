...
=== Number of Photons Arriving at P
...
The <</reference/math/linear-algebra/dot-product/explanations#,dot product>> comes to the rescue. Examine the following cases: the incoming light ray is represented by a yellow vector stem:[\vec i],
