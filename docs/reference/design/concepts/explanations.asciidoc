...
* <</extensions/pipeline/bmp/explanations#,BMP>> produces BMP files instead of WIFs. While BMP might be
  readable by most graphics programs, it does not support animations.
* <</extensions/pipeline/ppm/explanations#,PPM>> produces PPM files instead of WIFs.
  This makes it possible to produce "real" movies (mp4, animated gifs, &hellip;) using an external tool like ``ffmpeg``.
* <</extensions/pipeline/motion-blur/explanations#Motion blur>> comes after the renderer and adds bitmaps together, thereby creating
  a motion blur effect.
* <</extensions/pipeline/inverter/explanations#,Inverter>> inverts the bitmaps produced by the renderer.
* <</extensions/pipeline/overprint#,Overprint>> combines all bitmaps into one single bitmap.
...
* The <</extensions/renderers/split-depth/explanations#,Split Depth Renderer>> produces <a href="https://www.reddit.com/r/SplitDepthGIFS/">split depth animations</a>.
...
<</extensions/performance/parallel-task-scheduler#,more advanced scheduler>>
...
* Spheres
* <</extensions/primitives/plane-xz/explanations#,Planes>>
* <</extensions/primitives/cylinder-along-x/explanations#,Cylinders>>
* <</extensions/primitives/cone-along-x/explanations#,Cones>>
* <</extensions/primitives/triangle/explanations#,Triangles>>
* <</extensions/primitives/disk/explanations#,Disks>>
* <</extensions/primitives/square-xy/explanations#,Squares>>
* <</extensions/primitives/cube/explanations#,Cubes>>

You can also combine primitives, yielding new primitives:

* <</extensions/primitives/union/explanations#,Unions>>
