...
The easiest way to check if a hit occurs between stem:[L] and stem:[P] is to rely on the <</reference/math/misc/ray/explanations#,stem:[t]-value>> of the hit.
...
// Referred to from external page
[#approxerrs]
