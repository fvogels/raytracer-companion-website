...
[TASK]
====
Write tests that check multiplication between quaternions (both ``$$*$$`` and ``*=``):

* stem:[(0 + 0i + 0j + 0k) \cdot (0 + 0i + 0j + 0k) = (0 + 0i + 0j + 0k)]
* stem:[(1 + 0i + 0j + 0k) \cdot (1 + 0i + 0j + 0k) = (1 + 0i + 0j + 0k)]
* stem:[(1 + 0i + 0j + 0k) \cdot (0 + 1i + 0j + 0k) = (0 + 1i + 0j + 0k)]
* stem:[(1 + 0i + 0j + 0k) \cdot (0 + 0i + 1j + 0k) = (0 + 0i + 1j + 0k)]
* stem:[(1 + 0i + 0j + 0k) \cdot (0 + 0i + 0j + 1k) = (0 + 0i + 0j + 1k)]
* stem:[(0 + 1i + 0j + 0k) \cdot (1 + 0i + 0j + 0k) = (0 + 1i + 0j + 0k)]
* stem:[(0 + 1i + 0j + 0k) \cdot (0 + 1i + 0j + 0k) = (-1 + 0i + 0j + 0k)]
* stem:[(0 + 1i + 0j + 0k) \cdot (0 + 0i + 1j + 0k) = (0 + 0i + 0j + 1k)]
* stem:[(0 + 1i + 0j + 0k) \cdot (0 + 0i + 0j + 1k) = (0 + 0i - 1j + 0k)]
* stem:[(0 + 0i + 1j + 0k) \cdot (1 + 0i + 0j + 0k) = (0 + 0i + 1j + 0k)]
* stem:[(0 + 0i + 1j + 0k) \cdot (0 + 1i + 0j + 0k) = (0 + 0i + 0j - 1k)]
* stem:[(0 + 0i + 1j + 0k) \cdot (0 + 0i + 1j + 0k) = (-1 + 0i + 0j + 0k)]
* stem:[(0 + 0i + 1j + 0k) \cdot (0 + 0i + 0j + 1k) = (0 + 1i + 0j + 0k)]
* stem:[(0 + 0i + 0j + 1k) \cdot (1 + 0i + 0j + 0k) = (0 + 0i + 0j + 1k)]
* stem:[(0 + 0i + 0j + 1k) \cdot (0 + 1i + 0j + 0k) = (0 + 0i + 1j + 0k)]
* stem:[(0 + 0i + 0j + 1k) \cdot (0 + 0i + 1j + 0k) = (0 - 1i + 0j + 0k)]
* stem:[(0 + 0i + 0j + 1k) \cdot (0 + 0i + 0j + 1k) = (-1 + 0i + 0j + 0k)]
====
...
* Axis stem:[(0, 1, 0)], angle of 0 degrees, the point stem:[(0, 0, 0)] will be rotated to stem:[(0, 0, 0)].
* Axis stem:[(0, 1, 0)], angle of 0 degrees, the point stem:[(1, 0, 0)] will be rotated to stem:[(1, 0, 0)].
* Axis stem:[(0, 1, 0)], angle of 0 degrees, the point stem:[(0, 1, 0)] will be rotated to stem:[(0, 1, 0)].
* Axis stem:[(0, 1, 0)], angle of 0 degrees, the point stem:[(0, 0, 1)] will be rotated to stem:[(0, 0, 1)].
* Axis stem:[(0, 1, 0)], angle of 90 degrees, the point stem:[(0, 0, 0)] will be rotated to stem:[(0, 0, 0)].
* Axis stem:[(0, 1, 0)], angle of 90 degrees, the point stem:[(1, 0, 0)] will be rotated to stem:[(0, 0, -1)].
* Axis stem:[(0, 1, 0)], angle of -90 degrees, the point stem:[(1, 0, 0)] will be rotated to stem:[(0, 0, 1)].
* Axis stem:[(0, 1, 0)], angle of 180 degrees, the point stem:[(1, 0, 0)] will be rotated to stem:[(-1, 0, 0)].
* Axis stem:[(0, 1, 0)], angle of 360 degrees, the point stem:[(1, 0, 0)] will be rotated to stem:[(1, 0, 0)].
* Axis stem:[(1, 0, 0)], angle of 90 degrees, the point stem:[(1, 0, 0)] will be rotated to stem:[(1, 0, 0)].
* Axis stem:[(1, 0, 0)], angle of 90 degrees, the point stem:[(0, 1, 0)] will be rotated to stem:[(0, 0, 1)].
* Axis stem:[(1, 0, 0)], angle of -90 degrees, the point stem:[(0, 1, 0)] will be rotated to stem:[(0, 0, -1)].
* Axis stem:[(1, 0, 0)], angle of 180 degrees, the point stem:[(0, 1, 0)] will be rotated to stem:[(0, -1, 0)].
* Axis stem:[(0, 0, 1)], angle of 90 degrees, the point stem:[(1, 0, 0)] will be rotated to stem:[(0, 1, 0)].
* Axis stem:[(0, 0, 1)], angle of -90 degrees, the point stem:[(1, 0, 0)] will be rotated to stem:[(0, -1, 0)].
* Axis stem:[(0, 0, 1)], angle of 180 degrees, the point stem:[(1, 0, 0)] will be rotated to stem:[(-1, 0, 0)].

You can rely on the following macros:
