...
we just assume that somehow, there's _always_ some "light seepage" that slightly illuminates
...
photons each light source stem:[L_{1,2,\dots}] emits and how many of those find their way to the
hit location:
