...
\begin{tikzpicture}[extension/.style={draw,minimum width=5cm,minimum height=1cm,font=\scshape,rounded corners=4pt,drop shadow},
  ...
  \begin{pgfonlayer}{main}
    ...
    \node[extension,hard,todo] (perlin 2d) at ($ (materials) + (6,-12) $) {\html{extensions/math/perlin2d}{Perlin 2D} \mathy};
    ...
    \node[extension,hard,todo] (perlin 3d) at ($ (materials) + (6,-14) $) {\html{extensions/math/perlin3d}{Perlin 3D} \mathy};
    ...
    \node[extension,difficulty=1] (triangle optimized) at ($ (triangle) + (6,0) $) {\html{extensions/primitives/triangle-optimized}{Optimized Triangle}};
    ...
    \node[extension,difficulty=3] (bounce animation) at ($ (animations) + (6,0) $) {\html{extensions/animations/bounce}{Bounce}};
