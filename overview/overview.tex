...
\begin{tikzpicture}[extension/.style={draw,minimum width=5cm,minimum height=1cm,font=\scshape,rounded corners=4pt,drop shadow},
  ...
  \begin{pgfonlayer}{main}
    ...
    \node[extension,difficulty=2] (optimized cone) at ($ (cone along x) + (6,0) $) {\html{extensions/primitives/cone-optimized}{Optimized Cone Along X}};
    \draw[dependency] (optimized cone) -| (cone along x);
