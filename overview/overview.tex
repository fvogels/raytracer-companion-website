...
\begin{tikzpicture}[extension/.style={draw,minimum width=5cm,minimum height=1cm,font=\scshape,rounded corners=4pt,drop shadow},
  ...
  \begin{pgfonlayer}{main}
    ...
    % \node[extension,difficulty=1,todo] at ($ (pattern 3d materials) + (6,0) $) {};
    ...
    \node[extension,easy,todo] (vertical lines pattern material) at ($ (voronoi 2d 1) + (0,-2) $) {\html{extensions/materials/pattern2d/vertical-lines}{Vertical ines}};
    \draw[dependency] (vertical lines pattern material) -| (pattern 2d materials);

    \node[extension,easy,todo] (grid pattern material) at ($ (vertical lines pattern material) + (0,-2) $) {\html{extensions/materials/pattern2d/grid}{Grid}};
    \draw[dependency] (grid pattern material) -| (pattern 2d materials);

    \node[extension,easy,todo] (checkered pattern material) at ($ (grid pattern material) + (0,-2) $) {\html{extensions/materials/pattern2d/checkered}{Checkered}};
    ...
    \node[extension,difficulty=2] (bounding box) at ($ (difference) + (0,-2) $) {\html{extensions/primitives/bounding-box-accelerator}{Bounding Box}};
    \draw[dependency] (bounding box) -| (primitives);

    \node[extension,hard,todo] (mesh) at ($ (bounding box) + (6,0) $) {\html{extensions/primitives/mesh}{Mesh}};
    \draw[dependency] (mesh) -- (bounding box);

    \node[extension,easy] (scaling) at ($ (bounding box) + (0,-2) $) {\html{extensions/primitives/scaling}{Scaling}};
