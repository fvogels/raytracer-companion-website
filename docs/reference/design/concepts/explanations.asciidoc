...
* <</extensions/primitives/shapes/box/explanations#,Squares>>
* <</extensions/primitives/shapes/box/explanations#,Boxes>>

You can also <</extensions/primitives/modifiers/csg/explanations#,combine primitives>>, yielding new primitives.
...
enabling the rendering of scenes involving <</reference/primitives/mesh/basics/explanations#,millions of primitives>>.
