...
Ideally, for a given point stem:[P] on the canvas, the depth of field camera would shoot a ray from every point of this square through stem:[P], but since there are infinitely many, this is not a realistic option.
