...
\newcommand{\html}[2]{\href{#1/explanations.html}{#2}}
...
\begin{tikzpicture}[extension/.style={draw,minimum width=5cm,minimum height=1cm,font=\scshape,rounded corners=4pt,drop shadow},
  ...
  \begin{pgfonlayer}{main}
    ...
    \node[extension,anchor=north,difficulty=3] (multijittered sampler) at ($ (nrooks sampler.south) + (0,-1) $) {\html{extensions/samplers/multijittered}{Multi-Jittered}};
    ...
    \node[extension,difficulty=4] (fisheye camera) at ($ (cameras) + (-90:4) $) {\html{extensions/cameras/fisheye}{Fisheye}};
    \draw[dependency] (fisheye camera) -- (cameras);

    \node[extension,difficulty=3] (depth of field camera) at ($ (cameras) + (-150:4) $) {\html{extensions/cameras/depth-of-field}{Depth of Field}};
    ...
    \node[extension,difficulty=3] (material transformer 3d) at ($ (material transformer 2d) + (0,-6) $) {\html{extensions/materials/transformer3d}{Transformer3D}};
    ...
    \node[extension,difficulty=5] (reading mesh) at ($ (triangle optimized) + (6,0) $) {\html{extensions/primitives/mesh}{Mesh}};
    \draw[dependency] ($ (reading mesh.north) $) |- (triangle);
    \draw[dependency] ($ (reading mesh.south) $) |- (bounding box);

    % \node[extension,difficulty=5] (optimizing mesh) at ($ (reading mesh) + (6,0) $) {\html{extensions/primitives/mesh/optimizing}{Optimizing Mesh}};
    % \draw[dependency] (optimizing mesh) -- (reading mesh);

    % \node[extension,difficulty=5] (rendering mesh) at ($ (optimizing mesh) + (6,0) $) {\html{extensions/primitives/mesh/rendering}{Rendering Mesh}};
    % \draw[dependency] (rendering mesh) -- (optimizing mesh);
    ...
    \node[extension,easy,difficulty=4] (intersection) at ($ (bumpifier) + (0,-2) $) {\html{extensions/primitives/intersection}{Intersection}};
    ...
    \node[extension,easy,difficulty=4] (difference) at ($ (intersection) + (0,-2) $) {\html{extensions/primitives/difference}{Difference}};
    ...
    \node[extension,difficulty=3] (parallel task scheduler) at ($ (performance) + (6,0) $) {\html{extensions/performance/parallel-task-scheduler}{Parallel Scheduler}};
    ...
    \node[extension,easy,difficulty=4] (motion blur) at ($ (pipeline) + (6,0) $) {\html{extensions/pipeline/motion-blur}{Motion Blur}};
    ...
    \node[extension,easy,difficulty=2] (studio) at ($ (pipeline) + (6,-6) $) {\html{extensions/pipeline/studio}{Studio}};
    \draw[dependency] (studio) -| (pipeline);
    ...
    \node[extension,difficulty=3] (quadratic animation) at ($ (elastic animation) + (0,-2) $) {\html{extensions/animations/quadratic}{Quadratic}};
    \draw[dependency] (quadratic animation) -| (easing library);

    \node[extension,difficulty=3] (cubic animation) at ($ (quadratic animation) + (0,-2) $) {\html{extensions/animations/cubic}{Cubic}};
    \draw[dependency] (cubic animation) -| (easing library);

    \node[extension,difficulty=3] (quintic animation) at ($ (cubic animation) + (0,-2) $) {\html{extensions/animations/quintic}{Quintic}};
    ...
    \node[extension,difficulty=3] (lissajous animation) at ($ (quaternions) + (0,-2) $) {\html{extensions/animations/lissajous}{Lissajous}};
