...
\begin{tikzpicture}[extension/.style={draw,minimum width=5cm,minimum height=1cm,font=\scshape,rounded corners=4pt,drop shadow},
  ...
  \begin{pgfonlayer}{main}
    ...
    \node[extension,difficulty=5] (reading mesh) at ($ (triangle optimized) + (6,0) $) {\html{extensions/primitives/mesh/reading}{Reading Mesh}};
    \draw[dependency] ($ (reading mesh.north west) ! 0.5 ! (reading mesh.north) $) |- (triangle);
    \draw[dependency] ($ (reading mesh.south west) ! 0.5 ! (reading mesh.south) $) |- (bounding box);
