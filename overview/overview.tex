...
\begin{tikzpicture}[extension/.style={draw,minimum width=5cm,minimum height=1cm,font=\scshape,rounded corners=4pt,drop shadow},
  ...
  \begin{pgfonlayer}{main}
    ...
    \node[extension,anchor=north,difficulty=2] (ray tracer v5) at ($ (ray tracer v4.south) + (0,-1) $) {\html{extensions/ray-tracers/v5}{Ray Tracer v5}};
    ...
    \node[extension,easy,todo] (pattern 2d materials) at ($ (materials) + (6,0) $) {\html{extensions/materials/patterns2d}{Patterns 2D}};
    \draw[dependency] (pattern 2d materials) -- (materials);

    \node[extension,hard,todo] (dalmatian 2d material) at ($ (pattern 2d materials) + (6,0) $) {\html{extensions/materials/pattern2d/dalmatian2d}{Dalmatian 2D}};
    \draw[dependency] (dalmatian 2d material) -- (pattern 2d materials);

    \node[extension,medium,todo] (worley 2d material) at ($ (materials) + (6,-8) $) {\html{extensions/materials/worley2d}{Worley 2D}};
    \draw[dependency] (worley 2d material) -| (materials);

    \node[extension,hard,todo] (dalmatian 3d material) at ($ (pattern 2d materials) + (6,2) $) {\html{extensions/materials/pattern2d/dalmatian3d}{Dalmatian 3D}};
    \draw[dependency] (dalmatian 3d material) -| (pattern 2d materials);

    \node[extension,medium,todo] (worley 3d material) at ($ (materials) + (6,-10) $) {\html{extensions/materials/worley3d}{Worley 3D}};
    \draw[dependency] (worley 3d material) -| (materials);

    \node[extension,easy,todo] (lines pattern material) at ($ (pattern 2d materials) + (6,-2) $) {\html{extensions/materials/pattern2d/lines}{Lines}};
    \draw[dependency] (lines pattern material) -| (pattern 2d materials);

    \node[extension,easy,todo] (grid pattern material) at ($ (pattern 2d materials) + (6,-4) $) {\html{extensions/materials/pattern2d/grid}{Grid}};
    \draw[dependency] (grid pattern material) -| (pattern 2d materials);

    \node[extension,easy,todo] (checkered pattern material) at ($ (pattern 2d materials) + (6,-6) $) {\html{extensions/materials/pattern2d/checkered}{Checkered}};
    \draw[dependency] (checkered pattern material) -| (pattern 2d materials);

    \node[extension,medium,todo] (marble 2d material) at ($ (materials) + (6,-12) $) {\html{extensions/materials/marble2d}{Marble 2D}};
    \draw[dependency] (marble 2d material) -| (materials);

    \node[extension,medium,todo] (marble 3d material) at ($ (materials) + (6,-14) $) {\html{extensions/materials/marble3d}{Marble 3D}};
    \draw[dependency] (marble 3d material) -| (materials);

    \node[extension,difficulty=5] (voronoi 2d) at ($ (dalmatian 2d material) + (6,0) $) {\html{extensions/math/voronoi2d}{Voronoi 2D} \mathy};
    \draw[dependency] (dalmatian 2d material) -- (voronoi 2d);
    \draw[dependency] (worley 2d material) -| (voronoi 2d);

    \node[extension,difficulty=5] (voronoi 3d) at ($ (dalmatian 3d material) + (10,0) $) {\html{extensions/math/voronoi3d}{Voronoi 3D} \mathy};
    \draw[dependency] (dalmatian 3d material) -- (voronoi 3d);
    \draw[dependency] (worley 3d material) -| (voronoi 3d);

    \node[extension,hard,todo] (perlin 2d) at ($ (marble 2d material) + (6,0) $) {\html{extensions/math/perlin2d}{Perlin 2D} \mathy};
    \draw[dependency] (marble 2d material) -- (perlin 2d);

    \node[extension,hard,todo] (perlin 3d) at ($ (marble 3d material) + (6,0) $) {\html{extensions/math/perlin3d}{Perlin 3D} \mathy};
    \draw[dependency] (marble 3d material) -- (perlin 3d);

    \node[extension,medium,todo] (texture materials) at ($ (materials) + (6,-16) $) {\html{extensions/materials/texture}{Textures}};
    ...
    \node[extension,easy,todo] (material scale 2d) at ($ (material transformer) + (6,0) $) {\html{extensions/materials/transformers/2d/scaling}{Scale 2D}};
    \draw[dependency] (material scale 2d) -- (material transformer);

    \node[extension,easy,todo] (material scale 3d) at ($ (material transformer) + (6,-2) $) {\html{extensions/materials/transformers/3d/scaling}{Scale 3D}};
    \draw[dependency] (material scale 3d) -| (material transformer);

    \node[extension,easy,todo] (material translate 2d) at ($ (material transformer) + (6,-4) $) {\html{extensions/materials/transformers/2d/translation}{Translate 2D}};
    \draw[dependency] (material translate 2d) -| (material transformer);

    \node[extension,easy,todo] (material translate 3d) at ($ (material transformer) + (6,-6) $) {\html{extensions/materials/transformers/3d/translation}{Translate 3D}};
    \draw[dependency] (material translate 3d) -| (material transformer);

    \node[extension,easy,todo] (material rotate 2d) at ($ (material transformer) + (6,-8) $) {\html{extensions/materials/transformers/2d/rotation}{Rotate 2D}};
    \draw[dependency] (material rotate 2d) -| (material transformer);

    \node[extension,easy,todo] (material rotate 3d x) at ($ (material transformer) + (6,-10) $) {\html{extensions/materials/transformers/3d/rotation-x}{RotateX 3D}};
    \draw[dependency] (material rotate 3d x) -| (material transformer);

    \node[extension,easy,todo] (material rotate 3d y) at ($ (material transformer) + (6,-12) $) {\html{extensions/materials/transformers/3d/rotation-y}{RotateY 3D}};
    \draw[dependency] (material rotate 3d y) -| (material transformer);

    \node[extension,easy,todo] (material rotate 3d z) at ($ (material transformer) + (6,-14) $) {\html{extensions/materials/transformers/3d/rotation-z}{RotateZ 3D}};
    ...
    \node[extension,difficulty=3] (cone) at ($ (plane yz) + (0,-2) $) {\html{extensions/primitives/cone}{Cone}};
    \draw[dependency] (cone) -| (primitives);

    \node[extension,difficulty=2] (optimized cone) at ($ (cone) + (6,0) $) {\html{extensions/primitives/cone-optimized}{Optimized Cone}};
    \draw[dependency] (optimized cone) -| (cone);

    \node[extension,easy] (square xy) at ($ (cone) + (0,-2) $) {\html{extensions/primitives/square-xy}{Square XY}};
    \draw[dependency] (square xy) -| (primitives);

    \node[extension,easy] (optimized square xy) at ($ (square xy) + (6,0) $) {\html{extensions/primitives/square-xy-optimized}{Optimized Square XY}};
    \draw[dependency] (optimized square xy) -| (square xy);

    \node[extension,easy] (square xz) at ($ (square xy) + (0,-2) $) {\html{extensions/primitives/square-xz}{Square XZ}};
    \draw[dependency] (square xz) -| (primitives);

    \node[extension,easy] (optimized square xz) at ($ (square xz) + (6,0) $) {\html{extensions/primitives/square-xz-optimized}{Optimized Square XZ}};
    \draw[dependency] (optimized square xz) -| (square xz);

    \node[extension,easy] (square yz) at ($ (square xz) + (0,-2) $) {\html{extensions/primitives/square-yz}{Square YZ}};
    \draw[dependency] (square yz) -| (primitives);

    \node[extension,easy] (optimized square yz) at ($ (square yz) + (6,0) $) {\html{extensions/primitives/square-yz-optimized}{Optimized Square YZ}};
    \draw[dependency] (optimized square yz) -| (square yz);

    \node[extension,easy,todo] (cube) at ($ (square yz) + (0,-2) $) {\html{extensions/primitives/cube}{Cube}};
    \draw[dependency] (cube) -| (primitives);

    \node[extension,easy,todo] (optimized cube) at ($ (cube) + (6,0) $) {\html{extensions/primitives/cube-optimized}{Optimized Cube}};
    \draw[dependency] (optimized cube) -| (cube);

    \node[extension,easy,todo] (cylinder) at ($ (cube) + (0,-2) $) {\html{extensions/primitives/cylinder}{Cylinder}};
    \draw[dependency] (cylinder) -| (primitives);

    \node[extension,easy,todo] (optimized cylinder) at ($ (cylinder) + (6,0) $) {\html{extensions/primitives/cylinder-optimized}{Optimized Cylinder}};
    \draw[dependency] (optimized cylinder) -| (cylinder);

    \node[extension,easy,todo] (disk) at ($ (cylinder) + (0,-2) $) {\html{extensions/primitives/disk}{Disk}};
    ...
    \node[extension,easy,todo] (triangle) at ($ (disk) + (0,-2) $) {\html{extensions/primitives/triangle}{Triangle}};
    ...
    \node[extension,easy,todo] (perlin terrain) at ($ (smooth triangle) + (6,0) $) {\html{extensions/primitives/terrains/perlin}{Perlin Terrain}};
    \draw[dependency] (perlin terrain) -| (smooth triangle);

    \node[extension,hard,todo] (perlin 2d 2) at ($ (perlin terrain) + (6,0) $) {\html{extensions/math/perlin2d}{Perlin 2D} \mathy};
    \draw[dependency] (perlin terrain) -- (perlin 2d 2);

    \node[extension,easy,todo] (cropper) at ($ (triangle) + (0,-2) $) {\html{extensions/primitives/cropper}{Cropper}};
    ...
    \node[extension,hard,todo] (mesh) at ($ (difference) + (0,-2) $) {\html{extensions/primitives/mesh}{Mesh}};
    \draw[dependency] (mesh) -| (primitives);

    \node[extension,easy] (scaling) at ($ (mesh) + (0,-2) $) {\html{extensions/primitives/scaling}{Scaling}};
    ...
    \node[extension,easy] (parallel task scheduler) at ($ (performance) + (6,0) $) {\html{extensions/performance/parallel-task-scheduler}{Parallel Scheduler}};
    \draw[dependency] (parallel task scheduler) -- (performance);

    \node[extension,easy,todo] (bounding box) at ($ (performance) + (6,-2) $) {\html{extensions/performance/bounding-box}{Bounding Box}};
    \draw[dependency] (bounding box) -| (performance);
    ...
    \node[extension,easy,todo] (ppm) at ($ (pipeline) + (6,-4) $) {\html{extensions/pipeline/ppm}{PPM}};
    \draw[dependency] (ppm) -| (pipeline);

    \node[node] (animations) at ($ (pipeline) + (12,0) $) {Animations};
    \draw[dependency] (animations) |- (start);

    \node[extension,easy,todo] (bounce animation) at ($ (animations) + (6,0) $) {\html{extensions/animations/bounce}{Bounce}};
    \draw[dependency] (bounce animation) -- (animations);

    \node[extension,easy,todo] (elastic animation) at ($ (animations) + (6,-2) $) {\html{extensions/animations/elastic}{Elastic}};
    \draw[dependency] (elastic animation) -| (animations);

    \node[extension,easy] (quaternions) at ($ (animations) + (6,-4) $) {\html{extensions/math/quaternions}{Quaternions} \mathy};
    \draw[dependency] (quaternions) -| (animations);

    \node[extension,easy,todo] (circular animation) at ($ (quaternions) + (6,0) $) {\html{extensions/animations/circular}{Circular}};
    \draw[dependency] (circular animation) -- (quaternions);

    \node[extension,easy,todo] (lissajous animation) at ($ (animations) + (6,-6) $) {\html{extensions/animations/lissajous}{Lissajous}};
    \draw[dependency] (lissajous animation) -| (animations);

    \node[extension,easy,todo] (cyclic animation) at ($ (animations) + (6,-8) $) {\html{extensions/animations/cyclic}{Cyclic}};
    \draw[dependency] (cyclic animation) -| (animations);

    \node[extension,easy,todo] (quadratic in animation) at ($ (animations) + (6,-10) $) {\html{extensions/animations/quadratic-in}{Quadratic In}};
    \draw[dependency] (quadratic in animation) -| (animations);

    \node[extension,easy,todo] (quadratic out animation) at ($ (animations) + (6,-12) $) {\html{extensions/animations/quadratic-out}{Quadratic Out}};
    \draw[dependency] (quadratic out animation) -| (animations);

    \node[extension,easy,todo] (quadratic inout animation) at ($ (animations) + (6,-14) $) {\html{extensions/animations/quadratic-inout}{Quadratic InOut}};
    \draw[dependency] (quadratic inout animation) -| (animations);

    \node[extension,easy,todo] (cubic in animation) at ($ (animations) + (6,-16) $) {\html{extensions/animations/cubic-in}{Cubic In}};
    \draw[dependency] (cubic in animation) -| (animations);

    \node[extension,easy,todo] (cubic out animation) at ($ (animations) + (6,-18) $) {\html{extensions/animations/cubic-out}{Cubic Out}};
    \draw[dependency] (cubic out animation) -| (animations);

    \node[extension,easy,todo] (cubic inout animation) at ($ (animations) + (6,-20) $) {\html{extensions/animations/cubic-inout}{Cubic InOut}};
    \draw[dependency] (cubic inout animation) -| (animations);

    \node[extension,easy,todo] (quintic in animation) at ($ (animations) + (6,-22) $) {\html{extensions/animations/quintic-in}{Quintic In}};
    \draw[dependency] (quintic in animation) -| (animations);

    \node[extension,easy,todo] (quintic out animation) at ($ (animations) + (6,-24) $) {\html{extensions/animations/quintic-out}{Quintic Out}};
    \draw[dependency] (quintic out animation) -| (animations);

    \node[extension,easy,todo] (quintic inout animation) at ($ (animations) + (6,-26) $) {\html{extensions/animations/quintic-inout}{Quintic InOut}};
    \draw[dependency] (quintic inout animation) -| (animations);

    \node[extension,easy,todo] (point animation) at ($ (animations) + (6,-28) $) {\html{extensions/animations/point}{Points}};
    \draw[dependency] (point animation) -| (animations);

    \node[extension,easy,todo] (angle animation) at ($ (animations) + (6,-30) $) {\html{extensions/animations/angle}{Angles}};
    \draw[dependency] (angle animation) -| (animations);
    
    \node[extension,easy,todo] (material slicer) at ($ (animations) + (6,-32) $) {\html{extensions/materials/slicer}{Slicer}};
