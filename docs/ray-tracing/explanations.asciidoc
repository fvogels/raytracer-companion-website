...
| Next, ambient lighting is added.
  ...
  The problem with this approach is that you "destroy" all lighting information: you don't take into account <em>how much</em> light arrived at that point.
a| image::ray-tracer-v2.png[]
