...
\begin{tikzpicture}[extension/.style={draw,minimum width=5cm,minimum height=1cm,font=\scshape,rounded corners=4pt,drop shadow},
  ...
  \begin{pgfonlayer}{main}
    ...
    \node[extension,easy,todo] (material scale 3d) at ($ (material transformer 3d) + (6,0) $) {\html{extensions/materials/scaling3d}{Scale 3D}};
    \draw[dependency] (material scale 3d) -| (material transformer 3d);

    \node[extension,easy,todo] (material translate 3d) at ($ (material scale 3d) + (0,-2) $) {\html{extensions/materials/translation3d}{Translate 3D}};
    \draw[dependency] (material translate 3d) -| (material transformer 3d);

    \node[extension,easy,todo] (material rotate 3d) at ($ (material translate 3d) + (0,-2) $) {\html{extensions/materials/rotation3d}{Rotate 3D}};
