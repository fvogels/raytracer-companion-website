...
* A ray starting at point stem:[O = (O_\mathrm{x}, O_\mathrm{y}, O_\mathrm{z})] and having direction stem:[\vec\Delta = (\vec\Delta_\mathrm{x}, \vec\Delta_\mathrm{y}, \vec\Delta_\mathrm{z})].
...
[stem]
++++
  (\vec\Delta' \cdot \vec\Delta') \cdot t^2 +
  (2 \cdot (O' - (0,0)) \cdot \vec\Delta') \cdot t +
  (O' - (0,0)) \cdot (O' - (0,0)) - R^2
++++
