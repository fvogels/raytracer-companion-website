...
This trend went on: real numbers allowed to take square roots of positive values and <</reference/math/misc/complex-numbers/explanations#,complex numbers>> also allow you to take roots of negative numbers.
...
On the <</reference/math/misc/complex-numbers/explanations#,page about complex numbers>> we briefly mentioned
...
To rotate around an axis that does not go through the origin, some extra effort is needed (see later.)
...
====
Do not confuse stem:[P] and stem:[p] in the formulae above.

* stem:[P] stands for the point stem:[(x, y, z)].
* stem:[p] stands for the quaternion stem:[xi+yj+zk].
====
