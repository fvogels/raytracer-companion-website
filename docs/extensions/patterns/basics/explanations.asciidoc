...
* Note how ``PrimitiveImplementation`` is the actual superclass for all primitives (spheres, planes, etc.)
...
It acts as a superclass for all 2D patterns and therefore will define all functionality common to 2D patterns.
