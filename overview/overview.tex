...
\begin{tikzpicture}[extension/.style={draw,minimum width=5cm,minimum height=1cm,font=\scshape,rounded corners=4pt,drop shadow},
  ...
  \begin{pgfonlayer}{main}
    ...
    \node[extension,difficulty=2] (cylinder along x) at ($ (cube) + (0,-2) $) {\html{extensions/primitives/cylinder-along-x}{Cylinder Along X}};
    ...
    \node[extension,easy,todo] (optimized cylinder along z) at ($ (cylinder along z) + (6,0) $) {\html{extensions/primitives/cylinder-optimized}{Optimized Cylinder Z}};
